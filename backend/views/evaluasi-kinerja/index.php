            ...
            'columns'      => [
				...
				/*[
                   'class' => 'kartik\grid\ActionColumn',
                    ...
                    'template' => '{view} {view2} {view3} {view4} {view5} {view6} {view7} {view8}',
					'header'   => 'Portofolio',
                    'dropdown' => false,
                    'vAlign' => 'middle',
                    ...
                    'buttons' => [
						...
						'view4' => function ($url, $model) {
                            return Html::a('Makul CPL', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view5' => function ($url, $model) {
                            return Html::a('Nilai', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view6' => function ($url, $model) {
                            return Html::a('Kuesioner', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view7' => function ($url, $model) {
                            return Html::a('Evaluasi', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view8' => function ($url, $model) {
                            return Html::a('Kinerja', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						/*'view9' => function ($url, $model) {
                            return Html::a('Soal UAS', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view10' => function ($url, $model) {
                            return Html::a('Kunci UAS', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view11' => function ($url, $model) {
                            return Html::a('Jawaban UAS', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view12' => function ($url, $model) {
                            return Html::a('Rekap Nilai SIAKAD', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view13' => function ($url, $model) {
                            return Html::a('Rekap Nilai CPMK', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view14' => function ($url, $model) {
                            return Html::a('Survei', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
						...
						'view15' => function ($url, $model) {
                            return Html::a('Portofolio', $url, [
                                'data-original-title' => 'Lihat',
                                'title'               => 'Lihat',
                                'data-toggle'         => 'tooltip',
                                'class'               => 'btn btn-primary btn-xs',
