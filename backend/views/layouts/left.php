        ...
        <?= dmstr\widgets\Menu::widget(
            [
                ...
                'items' => [
					...
					['label' => 'Kurikulum', 'icon' => 'graduation-cap', 'url' => '#',
					'items' => [
                                    // [
                                    //     'label' => 'CPL Individual', 'icon' => 'circle',
                                    //     'options' => ['role' => 'modal-remote'], 'url' => ['/monev-cpl/landing-individual'],
                                    // ],
                                    ['label' => 'Rumusan CPL', 'icon' => 'genderless', 'url' => ['/ref-cpl'],],
                                    ['label' => 'Mata Kuliah', 'icon' => 'genderless', 'url' => ['/ref-mata-kuliah'],],
					...
					['label' => 'Monev Pembelajaran', 'icon' => 'desktop', 'url' => ['/monev-pemb']],
                    //[
                        //'label' => 'CP Lulusan',
                        //'icon' => 'graduation-cap',
                        //'url' => '#',
            ...
            <li class="treeview">
                ...
                if (Yii::$app->assign->is(["administrator"])) {
                    if ($aplikasi = SetupAplikasi::find()->one()) {
                        echo Html::a('<i class="fa fa-cogs"></i> Pengaturan Aplikasi', ['/setup-aplikasi/update', 'id' => $aplikasi->id], [
                            'role' => 'modal-remote',
                        ]);
                    } else {
                        echo Html::a('<i class="fa fa-cogs"></i> Pengaturan Aplikasi', ['/setup-aplikasi/create'], [
                            'role' => 'modal-remote',
                        ]);
                    }
                }
