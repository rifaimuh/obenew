...
use Yii;
use backend\models\KajiUlang;
use backend\models\FileKaji;
use backend\models\RefKelas;
use backend\models\RefMataKuliah;
use backend\models\RefTahunAjaran;
use backend\models\searchs\KajiUlang as KajiUlangSearch;
...
class KajiUlangController extends Controller
{
    ...
    {
        $searchModel = new KajiUlangSearch();
	...
	public function actionFileKaji()
    {
        ...
        if ($model2->load(Yii::$app->request->post())) {
            ...
            $cek = FileKaji::findOne([
                'waktu'   		 => $model2->waktu,
                'tempat'         => $model2->tempat,
                'sekretaris' 	 => $model2->sekretaris,
    ...
    {
        if (($model = KajiUlang::findOne($id)) !== null) {
            return $model;
        }
