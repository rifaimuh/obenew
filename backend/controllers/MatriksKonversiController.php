...
use Yii;
use backend\models\MatriksKonversi;
use backend\models\searchs\MatriksKonversi as MatriksKonversiSearch;
 ...
 */
class MatriksKonversiController extends Controller
{
    ...
    {
        $searchModel = new MatriksKonversiSearch();
    ...
    {
        if (($model = MatriksKonversi::findOne($id)) !== null) {
            return $model;
        }
