...
use Yii;
use backend\models\EvaluasiKinerja;
use backend\models\RefKelas;
use backend\models\RefMataKuliah;
use backend\models\RefTahunAjaran;
use backend\models\searchs\EvaluasiKinerja as EvaluasiKinerjaSearch;
...
class EvaluasiKinerjaController extends Controller
{
    ...
    {
        if (($model = EvaluasiKinerja::findOne($id)) !== null) {
            return $model;
        }
