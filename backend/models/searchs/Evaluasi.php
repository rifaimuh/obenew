...
class Evaluasi extends EvaluasiModel
{
    ...
    public function rules()
    {
        return [
            [['id', 'status'], 'integer'],
            [['evaluasi', 'saran', 'created_at', 'updated_at', 'created_user', 'updated_user'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query = EvaluasiModel::find()->where(["id_ref_mata_kuliah"=>$jk]);
