...
use backend\models\Presensi as PresensiModel;

/**
 * Krs represents the model behind the search form of `backend\models\Krs`.
 */
class Presensi extends PresensiModel
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = PresensiModel::find()->where(['status'=>1]);
        ...
        $query->andFilterWhere([
            ...
            'file_presensi' => $this->file_presensi,
