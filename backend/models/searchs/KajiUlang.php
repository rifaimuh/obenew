...
use backend\models\KajiUlang as KajiUlangModel;
 ...
 */
class KajiUlang extends KajiUlangModel
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        //$query = KajiUlang::find()
            ...
            //->andWhere([KajiUlang::tableName() . '.id_ref_dosen' => $dosen->id]);
